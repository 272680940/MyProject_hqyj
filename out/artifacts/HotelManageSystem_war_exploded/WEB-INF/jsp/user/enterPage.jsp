            ...
            <tr>
                ...
                <td>
                    <div class="button-group">
                        ...
                        <button class="button border-green" onclick="roomInfo(${info.house.hId});"><span>详情</span></button>
                    </div>
                </td>
            </tr>
        </c:forEach>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="infoForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="feeTotal">
                        </div>
                    </div>
                    <div class="form-group">
    ...
    function enterRoom(cId) {
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                $("#room_regist_modal label[name='cName']").text(result.customer.cName);
                $("#room_regist_modal label[name='cPhone']").text(result.customer.cPhone);
                ...
                $("#room_regist_modal input[name='customerId']").val(result.customer.cId);
                $("#room_regist_modal input[name='houseId']").val(result.house.hId);
                $("#room_regist_modal input[name='eId']").val(result.eId);
            }
        });

        $("input[name='feeTotal']").val("");
