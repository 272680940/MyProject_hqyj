    ...
    <div class="panel-head">
        ...
        <div class="padding border-bottom">
            <ul class="search">
                <li>
                    <form>
                        房型：<input type="checkbox" value="">大床房&nbsp;&nbsp;
                        <input type="checkbox" value="">双床房&nbsp;&nbsp;
                        房间号：<input type="text" name="" title=""/>
        ...
        <tr>
            ...
            <td>
                <div class="button-group">
                    ...
                    <button class="button border-green enter_btn" type="button" onclick=""><span>详情</span></button>
                </div>
            </td>
        </tr>
        </c:forEach>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="modelInfo">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" style="width: 110px;">缴费金额(元):</label>
                        <div class="col-sm-2">
